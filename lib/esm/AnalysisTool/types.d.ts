 ...
 */
export declare type TAnalysisTool = {
    Drawbar: () => void;
    DualControl: () => void;
    Events: () => void;
    SingleControl: () => void;
...
export interface IAnalysisToolDelegate {
     ...
     */
    mediaInfo?: (mediaID: string, callback: (data: {
        fps?: number;
        width: number;
        height: number;
    }) => void) => void;
     ...
     */
    saveImage: (base64: string, complete: (data: string | HTMLImageElement | null) => void) => void;
}
/**
...
export declare type CaptureCallback = (fnCallback: () => void | null, data: {
    ImageNameGuid: string | HTMLImageElement;
}) => void;
...
export declare type SingleAnalysisMediaSpecifier = string[];
/** Event types for single analysis tool. */
export declare type SingleAnalysisEvent = 'capture';
/** Event handler. */
export declare type SingleAnalysisEventHandler = () => void;
...
export interface ISingleAnalysisTool {
    ...
    on: (type: SingleAnalysisEvent, fn: SingleAnalysisEventHandler, uid: string) => SingleAnalysisTool;
    hideImage: () => void;
...
export declare type SingleAnalysisTool = (settings: ISingleAnalysisToolSettings) => ISingleAnalysisTool;
